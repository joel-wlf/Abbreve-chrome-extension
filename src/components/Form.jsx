...
const Form = () => {
  ...
  const fetchData = (e) => {
    ...
    setIsLoading(true);
    e.preventDefault();
    const url = `https://abbreve.vercel.app/server/db/${userInput}.json`;
        ...
        <div className="mt-2 lg:mt-0 md:mt-4  lg:mb-24">
          <form
            ...
            <button
              ...
              className="bg-deeppurple text-ash font-semibold rounded-xl hover:scale-105 p-2 mt-4 md:mt-0 items-center flex justify-center h-[50px] min-w-[100px] w-full md:w-auto">
